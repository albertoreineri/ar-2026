...
date: 2021-07-29
description: "Il settore IT cambia in modo incredibilmente veloce. Tecnologie e linguaggi di programmazione che vanno di moda oggi diventeranno obsoleti domani. Le tendenze vanno e vengono e anche il mercato…"
tags: ["Web Dev"]
---
...
Il [TIOBE Programming Community Index](https://www.tiobe.com/tiobe-index/) è spesso utilizzato come standard del settore per determinare la popolarità dei linguaggi di programmazione. Viene pubblicato ogni mese e mostra come diversi linguaggi di programmazione hanno guadagnato o perso trazione rispetto al mese precedente. Pubblicano anche una breve analisi del settore ogni mese che riassume i cambiamenti più importanti che devi conoscere.

### 2. GITHUB OCTOVERSE

[GitHub Octoverse](https://octoverse.github.com/) è un report annuale che riassume le tendenze più importanti su GitHub. Ti fornisce una miriade di informazioni come:
...
È una risorsa eccellente e vale sicuramente la pena dare un’occhiata prima di decidere come andare avanti con l’apprendimento. Oltre al rapporto Octoverse pubblicato annualmente, GitHub ha anche una pagina [Explore](https://github.com/explore) . Qui, GitHub pubblica quotidianamente i repository, gli argomenti, le app e i framework più di tendenza.

### 3. STACK OVERFLOW INSIGHTS

Puoi trovare molte informazioni utili su quale linguaggio di programmazione scegliere anche nel sottodominio [Insights di Stack Overflow . ](https://insights.stackoverflow.com/)[Senza dubbio, il materiale più importante qui è il sondaggio annuale per gli sviluppatori](https://insights.stackoverflow.com/survey) di Stack Overflow che contiene tutto ciò che potresti voler sapere sul settore.
...
[Google Trends](https://trends.google.com/trends/) può aiutarti a scegliere quale linguaggio di programmazione imparare in tre modi diversi:
...
- siti di lavoro remoti come [We Work Remotely](https://weworkremotely.com/) ,
- reti professionali come [LinkedIn](https://www.linkedin.com/) ,
- sezioni di lavoro in riviste online per sviluppatori come [Smashing Jobs](https://www.smashingmagazine.com/jobs/) ,
- newsletter professionali con una sezione di lavoro come [JavaScript Weekly](https://javascriptweekly.com/) .
