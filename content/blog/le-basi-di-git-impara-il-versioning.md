...
## 1. INSTALLAZIONE DI GIT:[](https://albertoreineri.it/blog/le-basi-di-git/#1-installazione-di-git)
...
### Windows:[](https://albertoreineri.it/blog/le-basi-di-git/#windows)
...
### macOS:[](https://albertoreineri.it/blog/le-basi-di-git/#macos)
...
### Linux (Ubuntu):[](https://albertoreineri.it/blog/le-basi-di-git/#linux-ubuntu)
...
## 2. CREAZIONE DI UN REPOSITORY:[](https://albertoreineri.it/blog/le-basi-di-git/#2-creazione-di-un-repository)
...
## 3. AGGIUNTA DI FILE AL REPOSITORY:[](https://albertoreineri.it/blog/le-basi-di-git/#3-aggiunta-di-file-al-repository)
...
### Aggiunta di File al Repository:[](https://albertoreineri.it/blog/le-basi-di-git/#aggiunta-di-file-al-repository)
...
### Verifica dello Stato del Repository:[](https://albertoreineri.it/blog/le-basi-di-git/#verifica-dello-stato-del-repository)
...
### Conferma delle Modifiche con un Commit:[](https://albertoreineri.it/blog/le-basi-di-git/#conferma-delle-modifiche-con-un-commit)
...
## 4. COMMIT DELLE MODIFICHE:[](https://albertoreineri.it/blog/le-basi-di-git/#4-commit-delle-modifiche)
...
### Esecuzione del Commit:[](https://albertoreineri.it/blog/le-basi-di-git/#esecuzione-del-commit)
...
### Visualizzazione della Cronologia dei Commit:[](https://albertoreineri.it/blog/le-basi-di-git/#visualizzazione-della-cronologia-dei-commit)
...
### Ritorno a Versioni Precedenti (opzionale):[](https://albertoreineri.it/blog/le-basi-di-git/#ritorno-a-versioni-precedenti-opzionale)
...
### Visualizzazione delle Differenze (opzionale):[](https://albertoreineri.it/blog/le-basi-di-git/#visualizzazione-delle-differenze-opzionale)
...
## 5. CREAZIONE DI BRANCH:[](https://albertoreineri.it/blog/le-basi-di-git/#5-creazione-di-branch)
...
### Creazione di un Nuovo Branch:[](https://albertoreineri.it/blog/le-basi-di-git/#creazione-di-un-nuovo-branch)
...
### Cambio tra i Branch:[](https://albertoreineri.it/blog/le-basi-di-git/#cambio-tra-i-branch)
...
### Creazione e Cambio Branch in un Unico Passaggio:[](https://albertoreineri.it/blog/le-basi-di-git/#creazione-e-cambio-branch-in-un-unico-passaggio)
...
### Visualizzazione di Tutti i Branch:[](https://albertoreineri.it/blog/le-basi-di-git/#visualizzazione-di-tutti-i-branch)
...
### Merge di Branch:[](https://albertoreineri.it/blog/le-basi-di-git/#merge-di-branch)
...
## 6. UNIONE DI BRANCH:[](https://albertoreineri.it/blog/le-basi-di-git/#6-unione-di-branch)
...
### Spostamento al Branch di Destinazione:[](https://albertoreineri.it/blog/le-basi-di-git/#spostamento-al-branch-di-destinazione)
...
### Unione di Branch:[](https://albertoreineri.it/blog/le-basi-di-git/#unione-di-branch)
...
### Risoluzione dei Conflitti:[](https://albertoreineri.it/blog/le-basi-di-git/#risoluzione-dei-conflitti)
...
### Annullamento dell’Unione (opzionale):[](https://albertoreineri.it/blog/le-basi-di-git/#annullamento-dellunione-opzionale)
...
### Verifica del Risultato:[](https://albertoreineri.it/blog/le-basi-di-git/#verifica-del-risultato)
...
## 7. GESTIONE DEL VERSIONAMENTO:[](https://albertoreineri.it/blog/le-basi-di-git/#7-gestione-del-versionamento)
...
### Visualizzazione della Cronologia dei Commit:[](https://albertoreineri.it/blog/le-basi-di-git/#visualizzazione-della-cronologia-dei-commit-1)
...
### Tornare a Versioni Precedenti:[](https://albertoreineri.it/blog/le-basi-di-git/#tornare-a-versioni-precedenti)
...
### Creazione di un Nuovo Branch da un Commit Specifico (opzionale):[](https://albertoreineri.it/blog/le-basi-di-git/#creazione-di-un-nuovo-branch-da-un-commit-specifico-opzionale)
...
### Annullamento delle Modifiche Locali:[](https://albertoreineri.it/blog/le-basi-di-git/#annullamento-delle-modifiche-locali)
...
### Ripristino di File da un Commit Specifico (opzionale):[](https://albertoreineri.it/blog/le-basi-di-git/#ripristino-di-file-da-un-commit-specifico-opzionale)
...
### Utilizzo di `git diff`:[](https://albertoreineri.it/blog/le-basi-di-git/#utilizzo-di-git-diff)
...
### Ritorno al Branch Corrente:[](https://albertoreineri.it/blog/le-basi-di-git/#ritorno-al-branch-corrente)
...
## 8. COLLABORAZIONE SU GITHUB:[](https://albertoreineri.it/blog/le-basi-di-git/#8-collaborazione-su-github)
...
### Creazione di un Account su GitHub (se non hai già uno):[](https://albertoreineri.it/blog/le-basi-di-git/#creazione-di-un-account-su-github-se-non-hai-gi%C3%A0-uno)

Visita [GitHub](https://github.com/) e crea un account se non ne hai già uno.

### Creazione di un Nuovo Repository su GitHub:[](https://albertoreineri.it/blog/le-basi-di-git/#creazione-di-un-nuovo-repository-su-github)
...
### Collegamento del Repository Locale a GitHub:[](https://albertoreineri.it/blog/le-basi-di-git/#collegamento-del-repository-locale-a-github)
...
### Aggiornamento del Repository Locale da GitHub:[](https://albertoreineri.it/blog/le-basi-di-git/#aggiornamento-del-repository-locale-da-github)

Puoi scaricare le ultime modifiche dal repository su GitHub utilizzando il comando: `bash git pull origin main`

### Creazione di una Pull Request:[](https://albertoreineri.it/blog/le-basi-di-git/#creazione-di-una-pull-request)
...
### Revisione delle Pull Request:[](https://albertoreineri.it/blog/le-basi-di-git/#revisione-delle-pull-request)
...
### Fusione della Pull Request:[](https://albertoreineri.it/blog/le-basi-di-git/#fusione-della-pull-request)
...
### Sincronizzazione del Repository Locale:[](https://albertoreineri.it/blog/le-basi-di-git/#sincronizzazione-del-repository-locale)
...
## 9. RISOLUZIONE DI CONFLITTI:[](https://albertoreineri.it/blog/le-basi-di-git/#9-risoluzione-di-conflitti)
...
### Rilevamento di Conflitti:[](https://albertoreineri.it/blog/le-basi-di-git/#rilevamento-di-conflitti)
...
### Risoluzione Manuale dei Conflitti:[](https://albertoreineri.it/blog/le-basi-di-git/#risoluzione-manuale-dei-conflitti)
...
### Aggiunta e Commit delle Modifiche:[](https://albertoreineri.it/blog/le-basi-di-git/#aggiunta-e-commit-delle-modifiche)
...
### Fusione del Branch o Pull Request:[](https://albertoreineri.it/blog/le-basi-di-git/#fusione-del-branch-o-pull-request)
...
### Continuazione dell’Operazione Originale:[](https://albertoreineri.it/blog/le-basi-di-git/#continuazione-delloperazione-originale)
...
## 10. BEST PRACTICE PER UNA GESTIONE DEL CODICE EFFICACE:[](https://albertoreineri.it/blog/le-basi-di-git/#10-best-practice-per-una-gestione-del-codice-efficace)
...
## CONCLUSIONE:[](https://albertoreineri.it/blog/le-basi-di-git/#conclusione)
